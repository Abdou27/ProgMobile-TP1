...
public class MainActivity extends AppCompatActivity {
    private static final String CYCLEVIEPREFS = "cycle_vie_prefs";
    ...
    View.OnClickListener btnEnvoyerOnClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            // Enregistrer le texte envoyé
            // a) En utilisant SharedPreferences
            SharedPreferences.Editor editor = settings.edit();
            editor.putString("valeur", getTxtValeur());
            editor.commit();

            popUp("valeur enregistrée = " + settings.getString("valeur", ""));
        }
    };
    ...
    View.OnClickListener btnAct2OnClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            intent.putExtra("texte", settings.getString("valeur", "")) ;
